...
'''
Plain generator / coroutine scheduling using SimLiteWaitMixin.gwait / wait.
...
from SimLiteWaitMixin — they accept any arriving event or return None on timeout.

Key difference from process_schedule.py:
  process_schedule.py  ->  DSComponent + SimProcessMixin.gwait (condition-aware)
  coro_schedule.py     ->  standalone generators + SimLiteWaitMixin.gwait (timeout only)
'''

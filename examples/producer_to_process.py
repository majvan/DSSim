...
class MyComponent(DSComponent):
    def __init__(self, *args, **kwargs):
        ...
        prod.add_subscriber(DSCallback(starter), phase=DSPub.Phase.PRE)
        ...
        prod.add_subscriber(proc, phase=DSPub.Phase.PRE)
        ...
        starter = lambda e: \
            prod.add_subscriber(
                ...
                phase=DSPub.Phase.PRE)  # and connects the new process with the producer
        prod.add_subscriber(DSCallback(starter), phase=DSPub.Phase.PRE)

...
class Clerk(sim.Component):
    def process(self):
        while True:
            customer_list = yield from worktodo.check_and_gwait(cond=lambda e:worktodo['request'])  # get from the queue if available
...
assert events == 379997, f"Number of events {events} is out of expected range."

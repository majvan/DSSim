...
class TestDSFilter(unittest.TestCase):
    ...
    def test7_feeding_lambda(self):
        ...
        self.assertTrue((retval, fa.signaled) == (False, False))
        self.assertTrue(fa.finished() == False)
        retval = fa.check('Hello')
        self.assertTrue((retval, fa.signaled) == (False, False))
        self.assertTrue(fa.finished() == False)
        retval = fa.check('Ahoy')
        self.assertTrue((retval, fa.signaled) == (True, True))
        self.assertTrue(fa.finished() == True)
        self.assertTrue(fa.value == 'Ahoy')
        retval = fa.check('Ciao')
        self.assertTrue((retval, fa.signaled) == (True, True))
        self.assertTrue(fa.finished() == True)
        self.assertTrue(fa.value == 'Ahoy')
    ...
    def test8_feeding_future(self):
        ...
        self.assertTrue(fut.finished() == False)
        fut.finish('Ahoy')
        retval = fa.check(fut)  # When waiting for a future in a condition, a process registers the future notification which is then sent to the process
        self.assertTrue((retval, fa.signaled) == (True, True))
        self.assertTrue(fa.finished() == True)
    ...
    def test11_feeding_process(self):
        ...
        self.assertTrue(fa.signaled == False)
        self.assertTrue(fa.finished() == False)
        retval = fa.check('Hi')  # This will NOT forward the event to the process
        self.assertTrue((retval, fa.signaled) == (False, False))
        self.assertTrue(fa.finished() == False)
        self.assertTrue(p.finished() == False)
        retval = fa.check('Ahoy')  # The event is not forwarded => no finish
        self.assertTrue((retval, fa.signaled) == (False, False))
        self.assertTrue(fa.finished() == False)
        self.assertTrue(p.finished() == False)
        retval = fa.check('Ciao')  # Last check
        self.assertTrue((retval, fa.signaled) == (False, False))
        self.assertTrue(fa.finished() == False)
        self.assertTrue(p.finished() == False)
        ...
        retval = fa.check(p)  # When waiting for a future in a condition, a process registers the future notification which is then sent to the process
        self.assertTrue((retval, fa.signaled) == (True, True))
        self.assertTrue(fa.finished() == True)
        self.assertTrue(p.finished() == True)
        retval = fa.check('Ciao')  # Last check
    ...
    def test21_feeding_gen_pulsed(self):
        ...
        self.assertTrue(fa.finished() == False)
        self.assertTrue(fa.cond.finished() == True)
        retval = fa.check(fa.cond)  # When waiting for a condition, typically this event is sent to the process after gen is finished
        self.assertTrue((retval, fa.signaled) == (True, False))
        self.assertTrue(fa.finished() == False)
        self.assertTrue(fa.cond.finished() == True)
        retval = fa.check('Ciao')

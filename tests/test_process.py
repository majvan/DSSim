...
class TestSubscriberContext(unittest.TestCase):
    ...
    def test3_enter_exit(self):
        ...
        cm = (DSSubscriberContextManager(p, DSProducer.Phase.POST_MISS, (f,))
              + DSSubscriberContextManager(p, DSProducer.Phase.PRE, (a, c))
              + DSSubscriberContextManager(p, DSProducer.Phase.POST_HIT, (b,))
              + DSSubscriberContextManager(p, DSProducer.Phase.CONSUME, (e,)))
        cm.__enter__()
